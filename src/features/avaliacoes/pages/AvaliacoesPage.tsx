...
export default function AvaliacoesPage() {
  ...
  const {
    ...
    update,
    remove,
  } = useSupabaseCrud<Avaliacao>('avaliacoes', ['avaliacoes', selectedEstagioId]);
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full p-2 border border-gray-300 rounded-lg"
                placeholder="Pontos fortes e fracos do estagiário..."
              />
            </div>
                ...
                .map((av) => (
                  <tr key={av.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 text-gray-700 font-medium">
                      {
                        alunos.find(
                          (a) => a.id === estagios.find((e) => e.id === av.estagio_id)?.aluno_id
                        )?.nome
                      }
                    </td>
                    ...
                    <td className="px-6 py-4 font-black text-blue-800 text-lg">
                      {av.nota.toFixed(1)}
                    </td>
                    <td className="px-6 py-4 text-right flex justify-end gap-2">
                      ...
                      <button
                        onClick={() => confirm('Excluir?') && remove(av.id)}
