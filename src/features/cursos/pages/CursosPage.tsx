...
export default function CursosPage() {
  ...
  const handleEdit = (curso: Curso) => {
    ...
    setValue('escola_id', curso.escola_id);
    setValue('nivel_id', curso.nivel_id);
    setShowForm(true);
  };
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            <BookOpen className="text-blue-600" /> Cursos
          </h1>
          <p className="text-gray-500">Gerencie os cursos técnicos e profissionais.</p>
        </div>
        {!showForm && (
          <button
        ...
        <table className="w-full text-left">
          <thead className="bg-gray-50 border-b border-gray-100">
            <tr>
              ...
              <th className="px-6 py-4 text-sm font-semibold text-gray-600">Nível</th>
