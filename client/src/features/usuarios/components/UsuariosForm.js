  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <InputField label="Nome Completo" name="nome_completo" required placeholder="Ex: João da Silva" />
        <InputField label="Email (Login)" name="email" type="email" required placeholder="exemplo@segecs.com" />
        <InputField 
        ...
        <div className="space-y-1">
          ...
          >
            ...
            {niveis.map(n => <option key={n.id_nivel} value={n.id_nivel}>{n.nivel}</option>)}
          </select>
        </div>
